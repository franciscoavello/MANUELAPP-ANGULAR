...
class CursoAlumnosControllerTest < ActionController::TestCase
  ...
  test "should create curso_alumno" do
    assert_difference('CursoAlumno.count') do
      post :create, curso_alumno: { alumno_id: @curso_alumno.alumno_id, curso_id: @curso_alumno.curso_id, grupo_id: @curso_alumno.grupo_id }
    end
  ...
  test "should update curso_alumno" do
    patch :update, id: @curso_alumno, curso_alumno: { alumno_id: @curso_alumno.alumno_id, curso_id: @curso_alumno.curso_id, grupo_id: @curso_alumno.grupo_id }
    assert_redirected_to curso_alumno_path(assigns(:curso_alumno))
  end

...
class CursosControllerTest < ActionController::TestCase
  ...
  test "should create curso" do
    assert_difference('Curso.count') do
      post :create, curso: { año: @curso.año, nombre: @curso.nombre, profesor_id: @curso.profesor_id, semestre: @curso.semestre }
    end
  ...
  test "should update curso" do
    patch :update, id: @curso, curso: { año: @curso.año, nombre: @curso.nombre, profesor_id: @curso.profesor_id, semestre: @curso.semestre }
    assert_redirected_to curso_path(assigns(:curso))
  end
